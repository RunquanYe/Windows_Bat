...
powershell.exe -Command "Write-Host ([char]27 + '[31m')'Process Completion: '([char]27 + '[37m')'You need to input amount of seconds for countdown.'([char]27 + '[0m')"
ECHO.
...
powershell.exe -Command "Write-Host ([char]27 + '[31m')'Process Completion: '([char]27 + '[37m')'You need to input a the shutdown time in 24-hour format (HH:MM)'([char]27 + '[0m')"
ECHO.
...
powershell.exe -Command "Write-Host ([char]27 + '[31m')'Process Completion: '([char]27 + '[37m')'You need to provide a PID, and the system will shutdown once the process is done.'([char]27 + '[0m')"
ECHO.
